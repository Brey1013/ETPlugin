...
function et_dashboard_summary()
{
    ...
    <div class="row">
        ...
        <div class="col-md-6 col-12"><a href="<?php echo $woocommerce->cart->get_cart_url(); ?>">
                <?php echo $inCart ?>
                <?php _e('Saved in Cart', 'equipmenttrader'); ?>
            </a></div>
        <div class="col-md-6 col-12"><a href="../my-listings/?status=publish">
                <?php echo $published ?>
                <?php _e('Published Listings', 'equipmenttrader'); ?>
            </a></div>
        <div class="col-md-6 col-12"><a href="../my-listings/?status=featured">
                <?php echo $featured ?>
                <?php _e('Featured Listings', 'equipmenttrader'); ?>
            </a></div>
        <div class="col-md-6 col-12"><a href="../my-listings/?status=expired">
                <?php echo $expired ?>
